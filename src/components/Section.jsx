...
import { ArrowDown, FuelIcon, ArrowLeftRightIcon } from "lucide-react";
...
export default function Section() {
  return (
    <div className="flex justify-center items-starts min-h-[93vh] mt-[100px]">
        ...
        <FuelIcon className=" rounded-full p-4  text-white h-13 w-13"/>
        </div>
      <div className="bg-[#120f29] h-[500px] w-[400px] rounded-2xl shadow-md ">
        ...
        <div className="flex justify-center relative items-center flex-col ">
          ...
          <div className="absolute top-[112px] flex justify-center">
